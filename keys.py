...
Multi_complete_list = ['готово', 'конец', 'закончил', 'получ', 'сделан', 'делать', 'оконч']  # Конец мультиплеера
Help_list = ['помощь', 'хелп']  # help()
Comm_list = ['команд', 'функц', 'операц', 'умеешь', 'уметь', 'возмож']  # commands()
An_Dan_list = ['Данетк', 'друг', 'иной', 'иную', 'новый', 'новую', 'следующ']  # another_Dan()
Repeate_list = ['повтор', 'занова', 'снова', 'еще раз', 'по новой', 'сначал', 'заново']  # repeate_Dan()
Wt_i_kn_list = ['угад', 'знать', 'знаю', 'разгад', 'гадал', 'гадать', 'уже']  # what_i_know()
Hint_list = ['подсказ', 'подскаж', 'помог', 'не могу', 'не знаю', 'не получается', 'подсоб']  # hint()
Rules_list = ['правил', 'услов']  # rules()
Continue_list = ['все понят', 'все понял', 'продолж', 'дальше', 'все ясно', 'вопросов нет', 'вопросов не имею']  # continue()
