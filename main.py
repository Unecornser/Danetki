...
def handle_dialog(res, req):
    ...
    if req['session']['new']:
        ...
        res['response']['text'] = 'Привет, давай играть в Данетки! Это увлекательная игра, где тебе нужно угадывать ' \
                                  'предыстории, которым последовала необычная ситуация. Ты знаешь правила игры?'
...
def txt_nat(text):
    ...
    text = text.replace("катерина", "катя")
    text = text.replace("катеринин", "катин")
    text = text.replace("екатеринин", "катин")
    text = text.replace("катеринино", "катино")
    text = text.replace("катеринина", "катина")
    text = text.replace("катеринины", "катины")
    text = text.replace("екатеринино", "катино")
    text = text.replace("екатеринины", "катины")
    text = text.replace("екатеринина", "катина")
