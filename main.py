        ...
        sessionStorage[user_id] = {
            ...
            'for_hints': {
                ...
                'Девушка в автобусе': {
                    ...
                    'Катя с кем то': [
                        {'он отец', 'была она папой с', 'дочь его катя мужчина отец', 'мужчина отец этот', 'родителями с', 'была девочка родителями с', 'выбор девушки косвенно на повлиял родитель', 'катей мужчина рядом с сидел', 'близко к кате родитель сидел', 'был мужчина рядом', 'девочка коленках на', 'была знакома катя мужчиной с этим', 'был девочкой папа с', 'ехала катя папой с', 'дочь катя мужчины', 'ее папа сидел', 'была катя мужчиной с', 'был кати папа это', 'катей кто рядом с сидел то', 'ее мужчина отец этот', 'кати папа сидел', 'ее отец сидел', 'катя папой с', 'есть кати папа у', 'мужчина ней рядом с сидел', 'кати он отец', 'девочка дочь его', 'он папа', 'была катя родителем с', 'близкую в входит кати ли семью человек', 'катей под родитель', 'был катей папа с', 'есть просто родитель', 'был кати отец это', 'ехал катей мужчина с', 'батей ехала она с', 'она родителями с', 'кати он папа', 'девочка папой с', 'была знакома катя мужчиной с', 'мужик папа', 'была кем она с то', 'кати отец сидел', 'была из катя кем родителей с то', 'папа сидел тоже', 'коленях на она родственника сидела у', 'под ребенком родители', 'девочка дочь мужчины', 'ехала катя кем с то', 'мужик отец', 'в герои данетке есть еще', 'батей ехала катя с', 'была девочка из кем родителей с то', 'знакомый кати пассажир', 'был папа ребенком с', 'колени место это', 'кем она с то', 'девочка дочь', 'был ее папа это', 'папа', 'была катя родителями с'}
                        , False, False
                    ],
                },
                'Загадочный человек': {
