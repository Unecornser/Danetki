            ...
            'for_hints': {
                ...
                'Безносая смерть': {
                    'То, что прошло 3 месяца - важно': [
                        {'3 временами года месяца с связаны', 'зимой предмет с связан этот', 'герой главный к месяцам относится', 'с связан сезонами', 'зимой кто с связанное то это', '3 жил месяца предмет этот', 'зимой предмет с связанное то что этот', 'временами года связанное со это', 'в осень происходило это', '3 длится жизнь месяца только этого', 'в осень происходит это', 'зимы он после пропал', 'года порой с связано это', '3 живет месяца оно только', 'осенью с связано это', 'к как лету относится предмет то этот', 'зимой с связано', 'к месяцам он относится', 'с связанное сезонами то что это', 'весной он с связанное то что', 'осенью это', 'весной это', 'весне к как он относится то', 'года оно с связано сезонами', '3 всего жил месяца предмет этот', '3 зимой месяца с сязанны', 'зимой как с связано то', 'время года', '3 жил месяца предмет только этот', 'конкретным не периодом с связано стало то чего', 'предмет с связанное снегом то что этот', '3 время года месяца это', 'с связанное снегом то что это', 'года он с связанное сезонами то что', 'кто осенью предмет с связанный то этот', 'действие летом происходит', 'зимой кто он с связанный то', 'весной кто с связанный то это', 'года определенным с связано сезоном это', 'кто он с связанный снегом то', 'летом с связано это', 'временами года с связано это', 'осенью предмет с связанное то что этот', 'временем года его с связана смерть', 'он осенью с связан', 'летом оно с связано', '3 живет месяца предмет этот', '3 жизнь месяца предмета только этого', 'года определенным периодом предмет с связан этот', 'весной предмет с связанное то что этот', '3 живет месяца он', 'кто осенью с связанный то это', 'времени его конкреным промежутком с связана смерть', 'года порой предмет с связан этот', 'в весну происходило это', 'весной оно с связано', 'года он определенным периодом с связан', '3 жизнь месяца этого', '3 всего длится жизнь месяца предмета этого', '3 живет месяца оно', 'кто летом он с связанный то', 'в зимы конце не предмета стало этого', '3 внимание месяца на необходимо обращать', '3 длится его жизнь месяца', '3 жило месяца оно только', 'к месяцам относится это', 'к как лету он относится то', 'временем года оно определенным с связано', 'времени года к она определенному относится', '3 живет месяца он только', 'зимой как предмет с связан то этот', '3 были декабрь и месяцами февраль январь', 'зимой оно с связано', 'года предмет с связан сезонами этот', 'года с связан сезонами', 'года кто оно с связанный сезонами то', 'зимой с связана ситуация эта', 'к как он осени относится то', 'временами года предмет с связанное то что этот', '3 всего живет месяца предмет этот', '3 месяца определенный период это', 'летом он с связан', 'к как оно осени относится то', 'временем года он с свзян', '3 длится жизнь месяца предмета этого', 'была в время осень это', 'кто летом предмет с связанный то этот', 'летом это', 'весной с связано это', 'года определенным периодом с связано это', '3 весны месяца', 'каким кого конкретным не периодом с связан стало то тот', 'осень', 'весной действие происходит', 'весной кто оно с связанное то', '3 года какого месяца принципиально сезона то', 'оно с связанное снегом то что', 'кто с связанное снегом то это', '3 важно именно ли месяца', '3 времени года какого месяца принципиально то', 'зимы он после умер', '3 жило месяца только это', 'не определенным периодом с связано стало то чего', 'весной предмет с связан этот', 'кого не определенным периодом с связан стало тот', 'к как осени относится предмет то этот', 'к как осени относится то это', 'бывает в конкретный он период', 'в он опрделенный период существует', 'зиме к как оно относится то', 'в зимы конце оно пропало', '3 всего жило месяца это', '3 важно месяца', '3 живет месяца предмет только этот', '3 длится жизнь месяца предмета только этого', 'к как лету относится то это', 'в зимы конце умерло это', 'зимой это', 'в зимы конце он пропал', 'в зимы конце оно умерло', 'кто оно с связанное снегом то', 'в зимы конце не стало этого', 'время года осень', 'бывает в он определенный период', 'каким не периодом с связано стало то то чего', 'лето', 'временами года кто он с связанный то', '3 внимание месяца на нужно обращать', 'время года лето', 'года кто он с связанный сезонами то', 'в зимы конце он умер', 'бывает весной это', '3 живет месяца только это', 'весной он с связан', 'весной кто он с связанный то', '3 года какого месяца принципиально сезона', 'временем года каким он с связан то', 'была в весна время это', 'к месяцам относится предмет этот', 'зимой кто с связанный то это', '3 важно именно месяца это', 'кто осенью с связанное то это', 'года с связано сезонами это', 'года он порами с связан', '3 всего живет месяца оно', 'зиме к как он относится то', 'каким конкретным не периодом с связано стало то то чего', 'зиме к как относится то это', 'летом он с связанное то что', 'временами года как с связано то это', 'весной с связанное то что это', 'было в время лето это', 'к как лету оно относится то', 'временами года связано со это', 'временами года кто с связанный то это', 'каким кого не периодом с связан стало то тот', '3 жило месяца оно', 'каким кого не определенным периодом с связан стало то тот', 'года оно определенным с связано сезоном', 'зимы оно после пропало', 'весна', 'временами года связанное со то что это', '3 жило месяца это', 'летом происходило это', 'весне к как оно относится то', '3 важно именно месяца', '3 декабрь месяца февраль это январь', '3 всего жизнь месяца этого', 'его с связана сезоном смерть', 'года кто предмет с связанный сезонами то этот', '3 всего жило месяца оно', 'весне к как относится то это', 'временами года с связано', 'в весну происходит это', 'зиме к как относится предмет то этот', 'зимой как с связано то это', 'года он с связан сезонами', '3 месяца осени', 'летом с связанное то что это', 'года он определенным с связан сезоном', '3 декабрь и месяца февраль это январь', '3 внимание именно месяца на необходимо обращать', 'его зимы не после стало', 'какой период то это', '3 важно месяца это', 'года с связанное сезонами то что это', '3 важно именно месяца что', '3 жизнь месяца предмета этого', 'а зимой', 'осенью с связанное то что это', '3 его жизнь месяца', '3 значение имеет месяца', 'временем года определенным с связано это', 'время года зима', 'временами года кто предмет с связанный то этот', '3 живет месяца это', '3 длится жизнь месяца этого', '3 всего живет месяца он', 'осенью происходило это', 'оно осенью с связано', 'весна он', 'весной кто предмет с связанный то этот', 'кто с связанный снегом то это', '3 лета месяца', 'бывает летом это', 'зимой с связанное это', 'временами года кто оно с связанное то', '3 время время года года3 месяца месяца одно это это', 'какой месяц он то', '3 года какого месяца периода принципиально', 'временем года он с связан', '3 года месяца свременем связанны', '3 были декабрь месяцами февраль январь', '3 внимание именно месяца на нужно обращать', 'кто летом с связанное то это', '3 всего жизнь месяца предмета этого', 'года предмет с связанное сезонами то что этот', 'зимы после умерло это', 'года кто с связанный сезонами то это', 'весной оно с связанное то что', 'летом предмет с связан этот', 'зимой с связана ситуация', 'кто предмет с связанный снегом то этот', 'весной происходило это', 'он осенью с связанное то что', 'зимой кто предмет с связанный то этот', 'временами года связанное со то точно что это', 'зимы оно после умерло', 'зивой с связанное это', 'бывает осенью это', 'временами года он с связанное то что', 'в лето происходит это', 'не периодом с связано стало то чего', 'временем года он определенным с связан', 'кто летом оно с связанное то', 'зимой с связанное то что это', 'осенью предмет с связан этот', 'к месяцам оно относится', 'года порами с связано это', 'года он порой с связан', 'летом предмет с связанное то что этот', 'года оно порой с связано', 'летом оно с связанное то что', '3 года какого месяца периода принципиально то', 'зимой как оно с связано то', 'зима он', '3 важно ли месяца он то умер через что', 'время года какое он то', 'временами года с связанное то что это', '3 месяца принципиально', 'зимой оно с связанное то что', 'зимой как с связана ситуация то', 'зимой кто оно с связанное то', '3 3 внимание вниманиена именно месяца месяца на нужно нужно обращать обращать', '3 важно именно ли месяца что', 'кто он осенью с связанный то', 'временем года оно с связано', 'зимнюю пору это', 'зимы не после стало этого', 'времени года к оно определенному относится', '3 времени года какого месяца принципиально', 'временами года оно с связанное то что', 'в лето происходило это', 'года порами предмет с связан этот', '3 его жизнь месяца только', 'зимой с связано это', 'времени года к определенному относится предмет этот', 'года оно определенным периодом с связано', 'временами года как с связано то', 'временем года предмет с связан это', '3 всего его жизнь месяца', 'каким не определенным периодом с связано стало то то чего', 'весна время года', 'временами года он с связан', 'зимой он с связанное то что', 'года определенным предмет с связан сезоном этот', '3 всего длится жизнь месяца этого', 'действие осенью происходит', 'года оно порами с связано', '3 время года какое месяца то это', 'кого не периодом с связан стало тот', 'времени года к он определенному относится', 'кого конкретным не периодом с связан стало тот', 'зимы не после предмета стало этого', 'время значение имеет', 'бывает зимой это', 'он с связанное снегом то что', 'весне к как относится предмет то этот', '3 всего живет месяца это', 'временем года с связано это', 'временами года с связана ситуация это', 'весной кто с связанное то это', '3 жил месяца он', 'в его зимы конце не стало', '3 зима месяца это', 'времени года к определенному относится это', '3 всего жил месяца он', 'кто летом с связанный то это', 'время года это', '3 жизнь месяца только этого', 'зимой как с связана ситуация то эта', 'летом он', '3 жил месяца он только', 'года оно с связанное сезонами то что', 'временами года с связана ситуация', 'временем года определенным предмет с связан этот'},
                        False, False],
                    'он не живое сущесво': [
                        {'одушевленное оно то что', 'кто одушевленное он то', 'неживой это', 'кого неживое укусили', 'кому неживое нос откусили тот', 'не одушевленое это', 'было живое существо это', 'живой кого ли тот укусили', 'живой не предмет этот', 'живой кто он то', 'неодушевленное то что это', 'живое он существо', 'неодушевленный предмет этот', 'герой главный одушевленный', 'живое то что это', 'неживой он предмет', 'неодушевленное оно то что', 'живое не предмет существо это', 'живое не он', 'живой не он', 'живое не существо это', 'живое предмет сужество этот', 'не человек это', 'кто неодушевленное он то', 'одушевленное он существо', 'живой кто предмет то этот', 'кто одушевленное оно то', 'не одушевленный он', 'неживое оно', 'неживое что', 'был живым он', 'живой кого тот укусили', 'кто одушевленное предмет то этот', 'живой кто то это', 'неживой предмет это', 'неодушевленное оно', 'неживое это', 'неживое он то что', 'герой главный живой', 'живое существо это', 'было живое не это', 'живое не он существо', 'был неживой он', 'было живое не существо это', 'неживое предмет то что этот', 'живое не он что', 'живое не он то что', 'живой кому нос откусили тот', 'живое не что', 'не существо это', 'неодушевленное предмет то что этот', 'неживое он существо', 'одушевленное это', 'живой кого нос он откусили того у', 'неживое оно то что', 'кого неживое тот укусили', 'кто неодушевленное то это', 'неживое то что это', 'живое оно', 'неодушевленный он', 'герой главный живое не существо', 'живое это', 'не одушивленное существо это', 'неодушевленное он то что', 'кто одушевленное то это', 'неживой он', 'живое сужество это', 'одушевленное существо это', 'неживое существо это', 'живой кому нос он откусили тот', 'живой кто то этот', 'кому неживое нос откусили', 'жевое не это', 'кто неживой то этот', 'живое не предмет сужество этот', 'не одушевленый он', 'живое предмет то что этот', 'неодушевленное это', 'он человек', 'одушевленное он', 'одушевленное он то что', 'живое он', 'живой он', 'было живое не то что это', 'кто неживой предмет то этот', 'живое предмет этот', 'живой кого нос откусили того у', 'живое ли не что что', 'живое не оно существо', 'одушевленное предмет то что этот', 'живой кого нос он откусили у', 'не одушивленное он существо', 'был живым не он', 'не одушевленное он существо', 'кто неодушевленное предмет то этот', 'кто неживой он то', 'живое он то что', 'живое оно существо', 'был живым не он предметом', 'был неживым он', 'кто неживой то это', 'живое не это', 'одушевленное то что это', 'душа есть него у', 'герой главный живое существо', 'кто неодушевленное оно то', 'живое оно то что', 'живой кого нос откусили у'},
                        False, False
                    ],
                    'он бывает только зимой': [
                        {'из снега фигура это', 'зимы после умерло это', 'дед мороз это', 'мороз предмет этот',
                         ...
                         'с связанное снегом то что это', 'было в зимних из месяцев один это'},
                        False, False
                    ]
                }
            }
